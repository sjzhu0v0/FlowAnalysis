...
void Init() {
  ...
  std::vector<double> signal_uplimit = {1e8, 3.2, 0.1, 10, 100};
...
void JpsiReco(
    string input_file = "/data/work/work_alice/Analysis/JpsiFlow/input/"
                        "AnalysisResults_new.root",
    string output_file =
        "/data/work/work_alice/Analysis/JpsiFlow/c2_11/output/JpsiReco.root") {
#ifdef roothttp
